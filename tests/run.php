...
echo "\n=== suites ===\n";
foreach (['schema_test', 'merch_test', 'log_test', 'fulfil_test', 'mailer_test', 'enquiry_test', 'catalogue_test', 'addons_test', 'access_test', 'access_unset_test', 'qr_test', 'admit_test'] as $suite) {
    $out = [];
